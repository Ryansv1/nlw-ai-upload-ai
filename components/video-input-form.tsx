...
const statusMessage = {
    converting: 'Convertendo vídeo para áudio...',
...
async function convertVideoToAudio(video: File){
    console.log('convertVideoToAudio')
...
const previewUrl = useMemo(() => {
    ...
    return(
        ...
        data-success={status === 'done'}
         ...
         disabled={status !== 'waiting'} type="submit" className="w-full data-[succes=true]:bg-emerald-400">
                {status === 'waiting' ? (
                    <>
                        Carregar Vídeo
